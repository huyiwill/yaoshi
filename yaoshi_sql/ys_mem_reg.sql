...
Date: 2017-12-11 17:25:27
*/

SET FOREIGN_KEY_CHECKS=0;

-- ----------------------------
-- Table structure for `ys_mem_reg`
-- ----------------------------
DROP TABLE IF EXISTS `ys_mem_reg`;
CREATE TABLE `ys_mem_reg` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 COMMENT='报名管理  个人注册';

-- ----------------------------
-- Records of ys_mem_reg
-- ----------------------------
INSERT INTO `ys_mem_reg` VALUES ('1', '396', 'asdfa', '13656585547', 'asdf', '2', '1', '2', '14', 'asdf', 'asdf', '1512982127');
