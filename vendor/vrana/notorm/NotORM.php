...
* @property-write-only mixed $debug = false Enable debugging queries, true for error_log($query), callback($query, $parameters) otherwise
* @property-write-only bool $freeze = false Disable persistence
* @property-write string $rowClass = 'NotORM_Row' Class used for created objects
* @property-write-only bool $jsonAsArray = false Use array instead of object in Result JSON serialization
