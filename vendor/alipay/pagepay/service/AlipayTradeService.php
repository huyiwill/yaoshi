...
require_once dirname(dirname(dirname ( __FILE__ ))).'/aop/AopClient.php';
require_once dirname(dirname(dirname ( __FILE__ ))).'/pagepay/buildermodel/AlipayTradePagePayContentBuilder.php';
