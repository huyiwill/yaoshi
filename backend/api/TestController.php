...
class TestController extends Controller
{
    ...
    public function actionAdd(Request $request, Response $response)
    {
        ...
        $test_id = $this->db->test()->where(['name' => $post['name'], 'status'=>[1,2]])->fetch('id');
        if ($test_id) {
    ...
    public function actionStatus(Request $request, Response $response)
    {
        ...
        $test_id = $this->db->test()->where(['id' => $post['id'], 'status'=>[1,2]])->fetch('id');
        if (empty($test_id)) {
    ...
    public function actionInfo(Request $request, Response $response)
    {
        ...
        $test_info = $this->db->test()->where(['id' => $get['id'], 'status'=>[1,2]])->fetch();
        if ($test_info) {
