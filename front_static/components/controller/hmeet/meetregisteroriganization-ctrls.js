angular
  .module('ohapp')
  .controller('meetregisteroriganizationCtrl', function meetregisteroriganizationCtrl($scope, $injector, $rootScope, ngDialog){
    ...
    $scope.add = function(){
      $scope.updates = {};
      ngDialog.open({
        template: 'backend_static/views/popup/p-subject.html',
        scope   : $scope
      });
      $scope.types = "add";
    };
