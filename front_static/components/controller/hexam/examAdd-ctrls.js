angular
    .module('ohapp')
    .controller('examAddCtrl', function examAddCtrl($scope, $injector, $rootScope,$stateParams) {
        ...
        $scope.chose = function (form) {
            if ($scope.chose_type == 1) {
                    ...
                    if ($scope.types == "edit") {
                        ...
                        $http
                            .post('/ts/add.json', {
                                ...
                                questions_id:$scope.updates.questions_id
                            })
                            .success(function (data) {
                                if (data.status) {
                ...
                console.log(form)
                console.log(!$scope.id_an)
                console.log($scope.updates.right_key4 || $scope.updates.right_key3 || $scope.updates.right_key2 || $scope.updates.right_key1)
