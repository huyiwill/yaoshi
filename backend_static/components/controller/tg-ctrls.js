angular
    .module('ohapp')
    .controller('tgCtrl', function tgCtrl($scope, $injector, $rootScope, ngDialog) {
        ...
        $scope.add = function () {
            $scope.updates = {};
            ngDialog.open({template: 'backend_static/views/popup/p-tg.html', scope: $scope});
            $scope.types = "add";
        };
        ...
        $scope.set_jin = function (id) {
            $http
                .post('/tg/status.json', {id: id, status: 2})
                .success(function (data) {
                    if (data.status) {
        ...
        $scope.recovery = function (id) {
            $http
                .post('/tg/status.json', {id: id, status: 1})
                .success(function (data) {
                    if (data.status) {
