angular
    .module('ohapp')
    .controller('studentCtrl', function studentCtrl($scope, $injector, $rootScope, ngDialog) {
        ...
        $scope.lead = function (page, order, filter_type, id) {
            ...
            var p = {page: page, order: order, role: 5};
        ...
        $scope.add = function () {
            ...
            ngDialog.open({template: 'backend_static/views/popup/p-student.html', scope: $scope});
            $scope.types = "add";
        };
        ...
        $rootScope.$on('ngDialog.opened', function (e, $dialog) {
            $('#entrance_time').jHsDate({
                format: 'yyyy-MM-dd',
                callBack: function () {
                    $scope.updates.perfect.entrance_time = $('#entrance_time').val();
                    $scope.$apply();
                }
            });
        });
                ...
                if ($scope.types == "edit") {
                    $http
                        .post('/user/update.json', {
                            ...
                            entrance_time: $scope.updates.perfect.entrance_time,
                            school: $scope.updates.perfect.school,
                            major: $scope.updates.perfect.major,
                            education: $scope.updates.perfect.education,
