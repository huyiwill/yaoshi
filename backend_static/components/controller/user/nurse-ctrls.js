angular
    .module('ohapp')
    .controller('nurseCtrl', function nurseCtrl($scope, $injector, $rootScope, ngDialog) {
        ...
        $scope.lead = function (page, order, filter_type, id) {
            ...
            var p = {page: page, order: order, role: 4};
        ...
        $scope.add = function () {
            $scope.updates = {};
            ngDialog.open({template: 'backend_static/views/popup/p-nurse.html', scope: $scope});
            $scope.types = "add";
        };
