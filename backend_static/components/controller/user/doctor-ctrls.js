angular
    .module('ohapp')
    .controller('doctorCtrl', function doctorCtrl($scope, $injector, $rootScope, ngDialog) {
        ...
        $scope.lead = function (page, order, filter_type, id) {
            ...
            var p = {page: page, order: order, role: 3};
        ...
        $scope.add = function () {
            $scope.updates = {};
            ngDialog.open({template: 'backend_static/views/popup/p-doctor.html', scope: $scope});
            $scope.types = "add";
        };
                ...
                if ($scope.types == "edit") {
                    $http
                        .post('/user/update.json', {
                            ...
                            teaching_department: $scope.updates.perfect.teaching_department,
