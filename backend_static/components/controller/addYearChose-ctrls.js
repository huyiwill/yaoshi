angular
    .module('ohapp')
    .controller('addYearChoseCtrl', function addYearChoseCtrl($scope, $injector, $rootScope, ngDialog, $stateParams) {
        ...
        $scope.chose_ti = function () {
            ...
            $http
                .post('/es/choice.json', {subjects:$scope.subjects,exercises_id:$scope.state_id,score:$scope.selectScole})
                .success(function (data) {
                    if (data.status) {
                        console.log(data);
                        history.back(-1);
