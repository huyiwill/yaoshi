angular
    .module('ohapp')
    .controller('majorCtrl', function majorCtrl($scope, $injector, $rootScope, ngDialog) {
        ...
        $scope.edit = function (id) {
            $http
                .get('/major/info.json', {params: {id: id}})
                .success(function (data) {
                    if (data.status) {
        ...
        $scope.set_jin = function (id) {
            $http
                .post('/major/status.json', {id: id, status: 2})
                .success(function (data) {
                    if (data.status) {
        ...
        $scope.recovery = function (id) {
            $http
                .post('/major/status.json', {id: id, status: 1})
                .success(function (data) {
                    if (data.status) {
