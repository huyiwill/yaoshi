angular
    .module('ohapp')
    .controller('add_danCtrl', function add_danCtrl($scope, $injector, $rootScope, ngDialog, $stateParams, $interval) {
        ...
        $scope.chose_this = function (t) {
            ...
            $('#analysis4').find($(".froala-element")).eq(0)[0].innerHTML='<p><br></p>';
            $('#analysis6').find($(".froala-element")).eq(0)[0].innerHTML='<p><br></p>';
            $('#right_key4').find($(".froala-element")).eq(0)[0].innerHTML='<p><br></p>';
            $('#right_key6').find($(".froala-element")).eq(0)[0].innerHTML='<p><br></p>';
        };
                    ...
                    if ($scope.types == "edit") {
                        ...
                        $http
                            .post('/subject/add.json', {
                                ...
                                therapeutic:$scope.updates.therapeutic
                            })
                            .success(function (data) {
                                if (data.status) {
