angular
    .module('ohapp')
    .controller('roleCtrl', function roleCtrl($scope, $injector, $rootScope, ngDialog) {
        ...
        $scope.add = function () {
            $scope.updates = {};
            ngDialog.open({template: 'backend_static/views/popup/p-role.html', scope: $scope});
            $scope.types = "add";
        };
        $scope.edit = function (id) {
            $http
                .get('/role/info.json', {params: {id: id}})
                .success(function (data) {
                    if (data.status) {
        ...
        $scope.set_jin = function (id) {
            $http
                .post('/role/status.json', {id: id, status: 2})
                .success(function (data) {
                    if (data.status) {
        ...
        $scope.recovery = function (id) {
            $http
                .post('/role/status.json', {id: id, status: 1})
                .success(function (data) {
                    if (data.status) {
